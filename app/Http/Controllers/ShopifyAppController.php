...
class ShopifyAppController extends Controller
{
    ...
    {
        $test = 2;
        return ($test == 1) ? view('test.test_one') : view('test.test_two');
    }

    public function getProductsWithShopifyApi()
    {      


        $requestHeaders = array( 
            'X-Shopify-Access-Token' => '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',
            'Api-Version' => 'unstable',
            'Authorization' => "Bearer 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"
        );

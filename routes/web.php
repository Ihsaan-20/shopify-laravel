...
Route::post('/webhook/shopify', [WebhookController::class, 'handleShopifyWebhook']);
...
Route::post('/webhook/customers-update', [WebhookController::class, 'handleCustomersUpdate']);
...
Route::get('/shopify-test', [TestingController::class, 'index']);
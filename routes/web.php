...
Route::get('/webhook/products-update', [WebhookController::class, 'handleProductUpdate']);
Route::post('/webhook/customers-update', 'WebhookController@handleCustomersUpdate');

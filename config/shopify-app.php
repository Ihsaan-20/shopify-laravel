...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'elementary-store-app'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '6caab75eb0bbcdb5d04f13c85b1d25e1'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '312be2ef4318c0d9c05e6e7d5975cf6a'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES',
                            'read_products,write_products,read_themes,customer_read_orders'
                        ),
    ...
    */
    ...
    //         ], [
    //             'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'PRODUCTS_CREATE'),
    //             'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://some-app.com/webhook/products-create'),
    //         ],
    ...
    //             'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://some-app.com/webhook/customers-create'),
    //         ],
